...
function mainImgSlider() {
  var el = document.querySelector('#sec-1-img'); //console.log(el)

  if (el) {
    var imgs = ['/assets/img/sec-1-img-1.png', '/assets/img/sec-1-img-2.png', '/assets/img/sec-1-img-3.png'];
    var i = 0;
    var len = imgs.length;
...
mainImgSlider(); //export { mainImgSlider }
