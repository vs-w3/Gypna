<x-layouts.admin >
    <form action="{{ url('admin/add/speciality') }}" method="post">
    @csrf
        ...
        <div class="w-full border rounded-md" x-data="{ tab: 'ka' }">
            ...
            <div x-show="tab == 'ka'">
                <div class="m-3">
                    ...
                    <input class="w-full block rounded border-gray-200 text-nt-0" id="name_ka" type="text" name="name_ka"  value="{{ old('name_ka') }}" placeholder="სახელი ქართულად">
                    @error('name_ka')
            ...
            <div  x-show="tab == 'en'">
                <div class="m-3">
                    ...
                    <input class="w-full block rounded border-gray-200 text-nt-0" id="name_en" type="text" name="name_en"  value="{{ old('name_en') }}" placeholder="სახელი ინგლისურად">
                    @error('name_en')
                        <div class="w-full mt-3 px-5 py-3 bg-nt-11 rounded text-white">{{ $message }}</div>
                    @enderror
                </div>
